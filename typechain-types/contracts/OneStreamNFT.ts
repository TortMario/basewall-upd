...
export interface OneStreamNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MINT_FEE"
      | "ROYALTY_PERCENTAGE"
...
export interface OneStreamNFT extends BaseContract {
  connect(runner?: ContractRunner | null): OneStreamNFT;
  waitForDeployment(): Promise<this>;

  interface: OneStreamNFTInterface;
